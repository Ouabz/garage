<aside class="main-sidebar fixed shadow2 bg-dark no-b sidebar-dark p-3">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview ">
                <li><a href="panel7-tasks.html"><i class="icon icon-circle-o"></i>Ajoutez un garage</a>
   
                <li><a href="panel7-tasks.html"><i class="icon icon-circle-o"></i>Ajoutez une marque</a>
   
                <li><a href="panel7-tasks.html"><i class="icon icon-circle-o"></i>Ajoutez un etat</a>
   
                <li><a href="add-vehicule.php"><i class="icon icon-circle-o"></i>Ajouter un véhicule</a>
   
                <li><a href="panel7-tasks.html"><i class="icon icon-circle-o"></i>Ajouter un état</a>
   
                <li><a href="panel7-tasks.html"><i class="icon icon-circle-o"></i>Modifier un véhicule</a>
