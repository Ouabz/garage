                    ...
                    <div class="col-md-8 ">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <form method="post" action="core/services.php?action=addVehicule" enctype="multipart/form-data">
         ...
         ?> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="vente_price" class="form-control" id="sku" placeholder="8900 €" required>
                                <div class="invalid-feedback">
                    ...
                    <div class="col-md-3">
                        <div class="card mt-4">
                            ...
                            <div class="card-body text-success">
                                ...
                                <input type="text" class="form-control" id="sku" placeholder="DS-782-AS" required>
                            </div>
