...
Class Connexion{
    ...
    public function __construct(){
        if(Connexion::$ON_DEMO==TRUE){
            $this->bdd = new PDO('mysql:host=localhost;dbname=mokdevst_', 'mokdev','Pokemon91170@', array(PDO::MYSQL_ATTR_INIT_COMMAND =>'SET NAMES utf8'));
        }else{
            $this->bdd = new PDO('mysql:host=localhost;dbname=bdd-insta', 'root','', array(PDO::MYSQL_ATTR_INIT_COMMAND =>'SET NAMES utf8'));
        }
    }
